#!/bin/bash
dnf update && dnf install dejavu-fonts liberation-fonts gnu-*-fonts google-*-fonts && dnf install xorg-* && dnf install xorg-x11-apps xorg-x11-drivers xorg-x11-drv-ati \
	...
	xorg-x11-xbitmaps xorg-x11-xinit xorg-x11-xkb-utils && dnf install adwaita-icon-theme atk atkmm at-spi2-atk at-spi2-core baobab \
